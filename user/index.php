...
<?php 
	...
	<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you want to update this record?</strong>
	...
	if(isset(($_POST['userID']))){
		...
		$sql ="UPDATE donor SET save_life_data='$crntDate'WHERE id='$userID'";
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<p class="text-center">Here you can mennage your account update your profile
							...
							<!-- Display Message here--></div>
							 ...
							 if ($safeDate=='0') {
								 ...
								 <button style="margin-top: 20px;" name="date" id="save_the_life"type="
								 submit" class=
								 "btn btn-lg btn-danger center-aligned ">Save The Life</button>
								 </form>' ;
								...
								<span> You Already Save the life.You Will donate the blood after three months.
							  We are very thanking full tu you.</span>
